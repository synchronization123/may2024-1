...
try {
    ...
    $user_id = $_SESSION['user_id'];
    $query = "SELECT a.assignment_id, a.assigned_date, a.title, a.aging, CONCAT(u.ufname, ' ', u.ulname) AS assigned_to, a.status, a.review_status, a.emanager_ir, a.certification_status, a.security_jira, a.functional_jira, a.koc_date, a.eta 
              FROM patches a
    ...
    <?php foreach ($assignments as $assignment) : ?>
        <tr>
            ...
            <td>
                                ...
                                <?php echo $assignment['emanager_ir']; ?>
