...
try {
    ...
    $query = "SELECT assignment_id, assigned_date, title, description, CONCAT(u.ufname, ' ', u.ulname) AS assigned_to, product_name, rm_pm 
              ...
              WHERE a.delete_flag = 0 AND a.status = 'Lead Approval Pending'";
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="assigned_to" name="assigned_to" required>
                                                ...
                                                $query_users = "SELECT user_id, CONCAT(ufname, ' ', ulname) AS full_name FROM users WHERE role_id = 3 AND delete_flag = 0";
